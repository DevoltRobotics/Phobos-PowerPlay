...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, "Izq");
        leftRear = hardwareMap.get(DcMotorEx.class, "Izq2");
        rightRear = hardwareMap.get(DcMotorEx.class, "Der2");
        rightFront = hardwareMap.get(DcMotorEx.class, "Der");
